 ...
 */
public class BGASwipeBackLayout2 extends ViewGroup {
    ...
    public BGASwipeBackLayout2(Context context) {
        this(context, null);
    }

    public BGASwipeBackLayout2(Context context, AttributeSet attrs) {
...
//            mDragHelper.captureChildView(mSlideableView, pointerId);
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(BGASwipeBackLayout2 parent, View child);
    }
